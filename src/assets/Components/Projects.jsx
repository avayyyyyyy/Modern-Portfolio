...
const Projects = () => {
  ...
  return (
    <>
      <div className="lg:w-screen lg:py-20 w-[100vw] lg:rounded-b-[100px] rounded-b-[50px]  gap-5 lg:pt-52 lg:mt-0 lg:text-left m-auto bg-white text-black px-2 py-12">
