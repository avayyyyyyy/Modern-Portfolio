  ...
  const data2 = [
    {
      ...
      shortDesc: "Created a complete Dice Game using ReactJs",
      Github: "https://github.com/avayyyyyyy/Dice-Game-React",
      LiveLink: "https://dice-game-react-lilac.vercel.app/",
      colorTheme: "#000",
    },
    {
      image: "/FoodApp.png",
      name: "ReactJs Food App",
      techStack: ["ReactJS", "TailwindCSS", "Redux Toolkit"],
      shortDesc:
        "Your all-in-one solution for efficiently tracking, organizing, and resolving tasks.",
      Github: "https://github.com/avayyyyyyy/Food-Redux-React",
      LiveLink: "https://food-redux-react.vercel.app/",
      colorTheme: "#000",
    },
  ];
              ...
              <>
                ...
                >
                  <img
                    alt=""
                    src={e.image}
                    className="h-56 w-full object-cover hover:scale-105 duration-150 transition-all "
                  />
                  ...
                  <div className="p-4 sm:p-6 space-y-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      type="button"
                      className="text-white bg-orange-600 hover:bg-orange-600/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2"
                      rel="noreferrer"
                    >
                      <svg
                        className="w-4 h-4 me-2"
